...
import { faMedium, faGithub, faTwitter, faXTwitter, faDiscord } from '@fortawesome/free-brands-svg-icons'


function Card() {
  return (
    <div className='flex justify-center items-center w-full h-32 text-white w-full lg:max-w-3xl md:max-w-xl max-w-sm mx-auto mt-12 md:mt-4'>
        <div className='flex flex-col md:flex-row items-center justify-center gap-8 w-full h-full'>
            ...
            <div className='w-1/2 md:w-auto'><DotExpandButton text="X" icon={faXTwitter} link="https://x.com/qBitTensorLabs" /></div>
            ...
            <div className='w-1/2 md:w-auto'><DotExpandButton text="Discord" icon={faDiscord} link="https://discord.com/invite/ysA3VJMWNb" /></div>
        </div>
    </div>
  )
}
